...
CREATE INDEX IF NOT EXISTS idx_sales_order_lines_org_order ON public.sales_order_lines(org_id, sales_order_id, display_order);

ALTER TABLE public.sales_order_lines ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS sales_order_lines_tenant_isolation ON public.sales_order_lines;
