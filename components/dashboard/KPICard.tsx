...
export function KPICard({ label, value, change, tone }: { label: string; value: number; change: string; tone: "good" | "warn" | "neutral" }) {
  ...
  return (
    <Card>
      ...
      <CardContent>
        <div className="text-2xl font-bold tabular-nums">{formatMoney(value)}</div>
